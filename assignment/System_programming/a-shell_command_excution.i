# 0 "shell_command_excution.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "shell_command_excution.c"
...
# 5 "shell_command_excution.c" 2

# 5 "shell_command_excution.c"
void main()
{
 int k=0,ind=0,i;
 int len;
 ...
 while(1)
 {
  ...
  __fpurge(
# 15 "shell_command_excution.c" 3 4
          stdin
# 15 "shell_command_excution.c"
               );
  scanf("%[^\n]",str);
  len=strlen(str);
  for(i=0;i<=len;i++)
